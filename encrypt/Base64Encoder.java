...
public class Base64Encoder {
    ...
    public int decode(byte[] var1, int var2, int var3, OutputStream var4) throws IOException {
        ...
        if (var10 == 0) {
            ...
            int var12;
            for(var12 = var10; var12 > var2 && var11 != 4; --var12) {
                if (!this.ignore((char)var1[var12 - 1])) {
                    ++var11;
                }
            }

            for(var11 = this.nextI(var1, var2, var12); var11 < var12; var11 = this.nextI(var1, var11, var12)) {
            ...
            var9 += this.decodeLastBlock(var4, (char)var1[var13], (char)var1[var14], (char)var1[var15], (char)var1[var16]);
            return var9;
        }
    }
